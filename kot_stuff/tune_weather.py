...
if debug:
    ...
    user_prompt = "What is the weather in Cambridge, Massachusetts?"
...
summarize_prompt = f"Use the following context to make a ONE SENTENCE summary. It is VERY IMPORTANT that it is SHORT: {full_output}"
