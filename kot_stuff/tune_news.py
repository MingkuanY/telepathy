...
if debug:
    ...
    user_prompt = "Tell me the top three headlines of breaking news in the US"
...
# SUMMARIZE FOR AUDIO TRANSCRIPTION

summarize_prompt = f"Use the following context to make a TWO SENTENCE OR SHORTER summary. It is VERY IMPORTANT that it is SHORT: {full_output}"
...
if stream:
    ...
    short_output = response.json()
    final_short_output = short_output['choices'][0]['message']['content']
    
    print("SPOKEN OUTPUT: " + final_short_output)
...
TEXT_TO_SPEAK = final_short_output  # Text you want to convert to speech
