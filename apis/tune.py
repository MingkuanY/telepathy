...
summarize_prompt = f"Use the following context to make a TWO SENTENCE OR SHORTER summary about the given person. It is VERY IMPORTANT that it is SHORT: {full_output}"
